    ...
    <div className="min-h-screen bg-primary-50 dark:bg-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm p-6">
          ...
          <div>
            <div className="flex items-center gap-2">
              <svg className="w-6 h-6" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <linearGradient id="shieldGradLogin" x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <path d="M16 2 L28 6 L28 14 C28 22 22 28 16 30 C10 28 4 22 4 14 L4 6 Z" 
                      fill="url(#shieldGradLogin)" stroke="#1a2e14" strokeWidth="1"/>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-300 mt-1">Ingreso al sistema</p>
          </div>
          <ThemeToggle />
        </div>
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)} autoComplete="off">
          <div>
            <label className="block text-sm font-medium text-slate-700 dark:text-slate-200">Usuario o Email</label>
            <input
            ...
            {errors.username_or_email && (
              <p className="mt-1 text-xs text-red-600">{errors.username_or_email.message}</p>
            )}
          </div>
          ...
          <div className="flex items-center justify-between gap-3 text-sm">
            <span className="text-slate-500 dark:text-slate-300">¿No tienes cuenta?</span>
            <Link to="/signup" className="text-primary-800 dark:text-primary-200 hover:underline">
              Crear cuenta
            </Link>
          </div>
        </form>
