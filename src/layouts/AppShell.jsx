        ...
        <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <svg className="w-5 h-5" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="shieldGradHeader" x1="0%" y1="0%" x2="0%" y2="100%">
              ...
              <path d="M16 2 L28 6 L28 14 C28 22 22 28 16 30 C10 28 4 22 4 14 L4 6 Z" 
                    fill="url(#shieldGradHeader)" stroke="#1a2e14" strokeWidth="1"/>
              <text x="16" y="20" fontFamily="Arial, sans-serif" fontSize="14" fontWeight="bold" 
                    fill="#FFFFFF" textAnchor="middle">C</text>
            </svg>
            <span className="font-semibold text-slate-900 dark:text-slate-50">CitySecure</span>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:flex items-center gap-2 rounded-lg border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 px-3 py-2">
              ...
              <span className="text-sm text-slate-700 dark:text-slate-200">{displayName}</span>
            </div>
            <button
              type="button"
