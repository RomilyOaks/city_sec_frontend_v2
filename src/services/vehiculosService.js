/**
 * File: c:\\Project\\city_sec_frontend_v2\\src\\services\\vehiculosService.js
 * @version 2.0.0
 * @description Servicio para operaciones relacionadas con vehículos: listados, CRUD y estadísticas.
 * @module src/services/vehiculosService.js
 */
...
/**
 * listVehiculos
 * Lista vehículos con paginación y filtros por estado operativo, tipo o texto de búsqueda.
 * @param {Object} [options]
 * @param {number} [options.page=1]
 * @param {number} [options.limit=20]
 * @param {string} [options.estado_operativo]
 * @param {string} [options.tipo_id]
 * @param {string} [options.search]
 * @returns {Promise<{vehiculos:Array,pagination:Object|null}>}
 */
