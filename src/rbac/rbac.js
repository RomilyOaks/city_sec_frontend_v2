...
export const ROUTE_PERMISSIONS = {
  ...
  reportes: ['reportes.novedades.read', 'reportes.personal.read', 'reportes.vehiculos.read'],
...
export const ACTION_PERMISSIONS = {
  ...
  usuarios_update_estado: ['usuarios.usuarios.update_estado', 'usuarios.usuarios.update'],
...
export function canAccessRoute(user, routeKey) {
  ...
  if (requiredPermisos && requiredPermisos.length > 0 && userPermisos && userPermisos.length > 0) {
